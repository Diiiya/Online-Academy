...
public class CourseController {
	 ...
	 * @param givesCertificate - whether or not the course awards a certificate upon
	 *                         completion
	...
	public void addCourse(String name, String description, String teacherName, int duration, Level level,
		...
		try {
			...
			Course course = new Course(name, description, teacherName, duration, level, category, price,
					givesCertificate, coverPhoto);
			em.persist(course);
	 ...
	 * @return Course object - the retrieved course from the database, matching the
	 *         given name
	 */
	...
	/**
	 * Method with 1 parameter that returns a list of courses for a specific user
	 * depending on the entered user id
	 * 
